            ...
            <div class="container p-3" id='articleOne'>
                <div class="row" >
                    ...
                    <div class="col-md-4 col-12 my-2 art-img pt-2" >
                        <img class="img-fluid img-thumbnail " src="{{url('/images//articles page.png')}}" alt="img-asset" />
                    </div>
                    ...
                    {{-- {/* start of an article preview */}  --}}
                    <div class="col-md-4 col-12 my-2 art-img pt-2">
                        <img class="img-fluid img-thumbnail " src="{{url('/images//articles page3.png')}}" alt="img-asset" />
                    </div>
                    <div class="col-md-8 col-12 text-start pb-2">
...
As those conversations progress or as your child ages, you can begin to include more specific and relevant information about effective birth control methods and how to prevent sexually transmitted infections.
                    ...
                    {{-- {/* start of an article preview */}  --}}
                    <div class="col-md-4 col-12 my-2 art-img pt-2">
                        <img class="img-fluid img-thumbnail " src="{{url('/images//articles page2.png')}}" alt="img-asset" />
                    </div>
                    <div class="col-md-8 col-12 text-start pb-2">
                    ...
                    {{-- {/* start of an article preview */}  --}}
                    <div class="col-md-4 col-12 my-2 art-img pt-2">
                        <img class="img-fluid img-thumbnail " src="{{url('/images//articles page4.png')}}" alt="img-asset" />
                    </div>
                    <div class="col-md-8 col-12 text-start pb-2">
