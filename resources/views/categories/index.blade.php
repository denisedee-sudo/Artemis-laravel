<x-guest-layout>
    ...
    <link rel="stylesheet" href="{{asset('css/app.css')}}">
        ...
        <div class=" text-jindigo text-jsan">
            ...
            <div class="row container-fluid" id="whoweare">
                ...
                <div class="col-12 col-lg-6">
                    <img src="{{url('/images/1.png')}}" alt="" class="img-fluid w-100 my-5 rounded shadow-lg hover-big" style="max-height: 450px;"/>
                </div>
            </div>

            <div class="container-fluid bg-diamond row text-jindigo text-jsan">
                <div class="col-12 col-lg-6 ">
                    <img src="{{url('/images/2.png')}}" alt="" class="img-fluid w-100 my-5 rounded shadow-lg hover-big" style="max-height: 450px;"/>
                </div>
            ...
            <div class="container-fluid row text-jindigo text-jsan">
                ...
                <div class="col-12 col-lg-6">
                    <img src="{{url('/images/3.png')}}" alt="" class="img-fluid w-100 my-5 rounded shadow-lg hover-big" style="max-height: 450px;">
                </div>
            </div>
        </div>
